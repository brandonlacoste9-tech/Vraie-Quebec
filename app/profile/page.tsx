    ...
    <div className="min-h-screen bg-black pt-24 px-4 pb-12">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-12">
          ...
          <div>
            <h1 className="text-3xl font-heading font-bold text-white uppercase">Julien Tremblay</h1>
        ...
        {activeTab === "wallet" && (
          <div className="space-y-12">
            ...
            <section>
              <h2 className="text-xl font-heading text-white uppercase mb-6 flex items-center gap-2">
